...
- [ ] Add key: `NSCalendarsUsageDescription`
  - Value: `"Full Screen Calendar Reminder needs access to your calendars to display full-screen alerts for your events."`
- [ ] Add key: `LSUIElement`
  - Type: Boolean
...
**Congratulations! Your Full Screen Calendar Reminder is ready to use.** 🎉
