...
2. Privacy & Security
3. Calendars
4. Enable for Full Screen Calendar Reminder
...
- Quit and restart Full Screen Calendar Reminder
...
```bash
# Force quit if stuck
killall "Full Screen Calendar Reminder"
```
...
2. Look for "Full Screen Calendar Reminder"
